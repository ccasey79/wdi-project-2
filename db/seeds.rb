...
u1 = User.create!(
  ...
  profile_picture: File.open(Rails.root.to_s + '/images/profile_picture.jpg'),
  password: "password",
...
u3 = User.create!(
  ...
  first_name: "Basil",
  last_name: "Brush",
  email: "basil@basil.com",
  profile_picture: File.open(Rails.root.to_s + '/images/basil.png'),
  password: "password",
  password_confirmation: "password"
)
...
u4 = User.create!(
  ...
  profile_picture: File.open(Rails.root.to_s + '/images/roland.jpg'),
  password: "password",
  password_confirmation: "password"
)    
...
r1 = Recipe.create!(
  ...
  user_id: u1.id,
  image: File.open(Rails.root.to_s + '/images/Lamb_Madras.jpg')
)
...
r2 = Recipe.create!(
  ...
  user_id: u2.id,
  image: File.open(Rails.root.to_s + '/images/Lamb_Bhuna.jpg')  
)
...
r3 = Recipe.create!(
  ...
  user_id: u3.id,
  image: File.open(Rails.root.to_s + '/images/Rogan_Josh.jpg') 
)
...
r4 = Recipe.create!(
  ...
  user_id: u4.id,
  image: File.open(Rails.root.to_s + '/images/Goan_Chicken_Curry.jpg')
)
...
r5 = Recipe.create!(
  ...
  user_id: u2.id,
  image: File.open(Rails.root.to_s + '/images/Kerala_Prawn_Curry.jpg') 
)
...
r6 = Recipe.create!(
  ...
  user_id: u3.id,
  image: File.open(Rails.root.to_s + '/images/Lamb_Dhansak.jpg') 
)  
...
r7 = Recipe.create!( 
  ...
  user_id: u4.id,
  image: File.open(Rails.root.to_s + '/images/Chicken_Naga.jpg')   
)
...
r8 = Recipe.create!(
  ...
  user_id: u1.id,
  image: File.open(Rails.root.to_s + '/images/Cocanut_Fish_Curry.jpg')
)      
...
r9 = Recipe.create!(
  ...
  user_id: u4.id,
  image: File.open(Rails.root.to_s + '/images/Lamb_Pasanda.jpg') 
)  
